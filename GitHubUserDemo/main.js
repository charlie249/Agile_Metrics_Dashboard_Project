async function getUserData() {
    ...
    document.querySelector('#info').innerHTML = `<strong> Labels: </strong> ${repoData.comments} <strong> Actions: </strong> ${repoData.actions}` // <strong> Following: </strong> ${repoData.following} `
