async function getUserData() {
    ...
    document.querySelector('#title').innerHTML = `<strong> Title: </strong> ${repoData.title} <strong> Number: </strong> ${repoData.number} <strong> Comments: </strong> ${repoData.comments_url} `
