async function getUserData() {
    ...
    document.querySelector('#info').innerHTML = `<strong> Labels: </strong> ${repoData} <strong> Pull Requests: </strong> ${repoData.followers}` // <strong> Following: </strong> ${repoData.following} `
